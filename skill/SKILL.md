---
name: skill-forge
description: Build portable AI skills from rough ideas, workflows, SOPs, or repeated tasks, either one at a time or in batches. Use when someone wants a skill, capability pack, custom instruction set, agent playbook, reusable prompt, or process an AI can follow consistently. Also trigger for requests like "make the AI do this every time," "turn this workflow into instructions," "package this process," "build skills for these SOPs," or "create a skill library for the team." Produces a SKILL.md with optional references, scripts, and assets, organized for progressive loading and use across AI tools.
---
